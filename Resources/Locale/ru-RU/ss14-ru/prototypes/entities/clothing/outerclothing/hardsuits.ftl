...
ent-ClothingOuterHardsuitSyndie = КВСТ тактический скафандр MK.III "Шаньлинь" 
    .desc = Продвинутый тактический скафандр производимый компанией "Технологии Кибердон", предоставляется "Мародёрам Горлекса" по скидке. Всё также собственность "Мародёров Горлекса"
